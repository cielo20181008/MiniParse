        ...
        // エンカウント情報の定義
        var encounterDefine = "{title} / {CurrentZoneName} / Time: {duration} / DPS: {encdps}";
        ...
        var headerDefine =
        [
          //  { html: "<img src='Job{JobOrName}.png.png',width='15' height='15' />", width: "5%", align: "center" },
            { text: "Name", width: "0.6%", align: "left" },
        ...
        [
            ...
            { text: "{name}", width: "0.7%"},
            { html: "<img src='jobicon/Job{Job}.png',width='20' height='20' />", width: "0.2%", align: "center" },
            { text: "{encdps}", width: "0.4%", align: "center" },
            { text: "{damage%}", width: "0.4%", align: "center" },
            { text: "{enchps}", width: "0.3%", align: "center" },
            { text: "{healed%}", width: "0.4%", align: "center" },
            { text: "{OverHealPct}", width: "0.2%", align: "center" },
            { text: "{deaths}", width: "0.2%", align: "center" },
        ];
